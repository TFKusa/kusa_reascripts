-- @description kusa_Implode soundbank iterations from block to takes (peak)
-- @version 1.04
-- @author Kusa
...
function loop()
    ...
    if visible then
        ...
        minDurChanged, minSilenceDuration = reaper.ImGui_SliderDouble(ctx, 'Min Duration', minSilenceDuration, 0.01, 2.0, "%.3f")
