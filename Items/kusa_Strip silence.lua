...
function getUserInputs()
    local retval, userInputs = reaper.GetUserInputs("Silence Parameters", 2, "Silence Threshold,Min Silence Duration", "0.002,0.2")
...
function main()
    ...
    silenceThreshold, minSilenceDuration = getUserInputs()
